        ...
        @tool(
            ...
            input_schema=_require_intend({
                ...
                "properties": {
                    ...
                    "retryFailedNode": {
                        "type": "boolean",
                        "description": "Set true only when Current Workspace Progress recommends retry_failed_node and the latest user message explicitly asks to continue or retry that failed node.",
                    },
                },
